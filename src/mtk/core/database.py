...
from mtk.core.models import Base
...
class Database:
    """Manages SQLite database connections for mtk shadow database."""
...
def get_db() -> Database:
    ...
    if _db is None:
        raise RuntimeError("Database not initialized. Run 'mtk init' first.")
    return _db
